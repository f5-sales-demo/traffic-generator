...
title: Desmontagem
description: >-
  terraform destroy para remover todos os recursos Azure, verificar exclusão do
  grupo de recursos com az CLI e limpar arquivos de estado locais
sidebar:
  order: 8
i18n:
...
:::tip
Para uso recorrente em demonstrações, considere criar scripts para o ciclo de vida completo: `cd terraform && terraform apply` antes de uma demonstração, execute os conjuntos e, em seguida, `terraform destroy` depois. O nível padrão é provisionado em 15 a 20 minutos, tornando a configuração e a desmontagem no mesmo dia algo prático.
:::
