...
O [servidor de origem](https://f5-sales-demo.github.io/origin-server/) fornece as aplicações de backend que os conjuntos de ataque do gerador de tráfego visam:
