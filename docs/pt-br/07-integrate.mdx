...
title: Integrar
description: >-
  Guia de integração do gerador de tráfego com servidor de origem, F5 XC HTTP
  load balancer, demonstração CSD e simulador CDN: diagramas de arquitetura,
  configuração de targeting, comparação de tráfego direto vs LB e implantação
...
O [servidor de origem](https://f5xc-salesdemos.github.io/origin-server/) fornece as aplicações de backend que os conjuntos de ataque do gerador de tráfego visam:
