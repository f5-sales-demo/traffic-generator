...
Tutti i file Terraform si trovano nella directory [`terraform/`](https://github.com/f5xc-salesdemos/traffic-generator/tree/main/terraform). Clonare il repository e distribuire direttamente:
...
:::tip
F16s_v2 è stata validata come opzione ottimale per il rapporto prezzo-prestazioni tramite benchmark A/B/C/D eseguiti su target CDN F16s_v2 e F32s_v2. Consultare [benchmarks/](https://github.com/f5xc-salesdemos/traffic-generator/tree/main/benchmarks) per i risultati completi.
:::
