...
Il [server di origine](https://f5-sales-demo.github.io/origin-server/) fornisce le applicazioni backend che le suite di attacco del generatore di traffico prendono come bersaglio:
