...
Der [Ursprungsserver](https://f5xc-salesdemos.github.io/origin-server/) stellt die Backend-Anwendungen bereit, auf die die Angriffspakete des Datenverkehrsgenerators abzielen:
