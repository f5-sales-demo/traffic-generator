...
title: टूल कैटलॉग
description: >-
  ट्रैफिक जनरेटर VM पर इंस्टॉल किए गए 50+ सुरक्षा टूल्स की पूर्ण कैटलॉग, श्रेणी
  के अनुसार व्यवस्थित, इंस्टॉल विधि, उदाहरण कमांड और ट्रैफिक सूट मैपिंग के साथ
sidebar:
  order: 4
  label: टूल कैटलॉग
i18n:
...
नीचे सूचीबद्ध हर टूल cloud-init प्रोविजनिंग के दौरान पूर्व-स्थापित होता है। डिप्लॉयमेंट के बाद किसी मैन्युअल इंस्टॉलेशन की आवश्यकता नहीं है।
...
GoTestWAF (Wallarm द्वारा) एक उद्योग-मानक WAF मूल्यांकन फ्रेमवर्क है जो पेलोड्स को कई एनकोडर्स (URL, Base64, JSUnicode) और प्लेसमेंट ज़ोन (body, header, URL param, cookie) के माध्यम से गुणित करता है। waf-bypass (Nemesida द्वारा) Base64, HTML-ENTITY, और UTF-16 एन्कोडिंग के साथ ARGS, BODY, COOKIE, और HEADER ज़ोन में पेलोड्स भेजता है।
...
SecLists कई टूल्स द्वारा उपयोग की जाने वाली वर्डलिस्ट प्रदान करता है जिनमें ffuf, gobuster, feroxbuster, dirb, और hydra शामिल हैं। PayloadsAllTheThings हमले की श्रेणी (XSS, SQLi, XXE) के अनुसार व्यवस्थित क्यूरेटेड मल्टी-एन्कोडिंग अटैक पेलोड्स प्रदान करता है जिनमें hex, octal, Unicode, HTML entity, double URL encoding, और JSFuck वेरिएंट शामिल हैं।

## केवल फुल टियर

ये टूल्स केवल तब इंस्टॉल होते हैं जब `tool_tier = "full"` हो:
...
| विधि | विवरण |
|---|---|
| apt | `apt-get install` के माध्यम से Ubuntu 24.04 APT रिपॉजिटरीज़ से इंस्टॉल किया गया |
...
| git clone | रिपॉजिटरी `/opt/` डायरेक्टरी में क्लोन की गई |
| git clone + pip | रिपॉजिटरी क्लोन की गई और Python डिपेंडेंसीज़ इंस्टॉल की गईं |
| installer script | cloud-init के दौरान वेंडर द्वारा प्रदान की गई इंस्टॉलर स्क्रिप्ट निष्पादित की गई |
