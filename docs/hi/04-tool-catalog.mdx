...
title: टूल कैटलॉग
description: >-
  ट्रैफ़िक जनरेटर VM पर इंस्टॉल किए गए 50+ सुरक्षा टूल्स का संपूर्ण कैटलॉग,
  श्रेणी के अनुसार व्यवस्थित, इंस्टॉल विधि, उदाहरण कमांड और ट्रैफ़िक सूट मैपिंग
  के साथ
sidebar:
  order: 4
i18n:
...
नीचे सूचीबद्ध प्रत्येक टूल cloud-init प्रोविज़निंग के दौरान पहले से इंस्टॉल किया जाता है। डिप्लॉयमेंट के बाद किसी मैनुअल इंस्टॉलेशन की आवश्यकता नहीं है।

## वेब एप्लिकेशन परीक्षण

| टूल | इंस्टॉल विधि | उदाहरण कमांड | उपयोगकर्ता सूट |
|---|---|---|---|
...
GoTestWAF (Wallarm द्वारा) एक उद्योग-मानक WAF मूल्यांकन फ्रेमवर्क है जो पेलोड को कई एन्कोडर (URL, Base64, JSUnicode) और प्लेसमेंट ज़ोन (body, header, URL param, cookie) में गुणा करता है। waf-bypass (Nemesida द्वारा) Base64, HTML-ENTITY, और UTF-16 एन्कोडिंग के साथ ARGS, BODY, COOKIE, और HEADER ज़ोन में पेलोड भेजता है।
...
Playwright अपनी स्वयं की Chromium बाइनरी `playwright install chromium` के माध्यम से इंस्टॉल करता है। Puppeteer जहाँ संभव हो वहाँ उसी सिस्टम Chromium का उपयोग करता है।
...
| टूल | इंस्टॉल विधि | स्थान | उपयोगकर्ता सूट |
|---|---|---|---|
...
SecLists वर्डलिस्ट प्रदान करता है जिनका उपयोग ffuf, gobuster, feroxbuster, dirb, और hydra सहित कई टूल्स द्वारा किया जाता है। PayloadsAllTheThings अटैक क्लास (XSS, SQLi, XXE) के अनुसार व्यवस्थित क्यूरेटेड मल्टी-एन्कोडिंग अटैक पेलोड प्रदान करता है जिसमें hex, octal, Unicode, HTML entity, double URL encoding, और JSFuck वेरिएंट शामिल हैं।
...
:::note
ZAP और Metasploit डिस्क फुटप्रिंट में लगभग 1.5 GiB और प्रोविज़निंग समय में 5-10 मिनट जोड़ते हैं। फुल टियर का उपयोग केवल तभी करें जब आपको विशेष रूप से डेमो के लिए इन टूल्स की आवश्यकता हो।
:::
