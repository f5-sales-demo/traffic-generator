...
ट्रैफ़िक जनरेटर एक मल्टी-लेयर डेमो वातावरण में एक घटक है। जब सभी घटक तैनात होते हैं तो पूर्ण आर्किटेक्चर इस प्रकार होता है:
...
| ट्रैफ़िक सूट | ऑरिजिन एप्लिकेशन | पाथ |
|---|---|---|
| api-attacks | VAmPI | `/vampi/` |
| bot-simulation | सभी एप्लिकेशन | सभी पाथ |
...
| mitre-attack | सभी एप्लिकेशन | सभी पाथ |
| owasp-scanning | सभी एप्लिकेशन | सभी पाथ |
| performance-testing | सभी एप्लिकेशन | सभी पाथ |
| reconnaissance | सभी एप्लिकेशन | सभी पाथ |
| restaurant-exploits | Restaurant API | `/restaurant/` |
| ssl-scanning | F5 XC LB (सीधे ऑरिजिन नहीं) | N/A |
| traffic-generation | सभी एप्लिकेशन | सभी पाथ |
| web-app-attacks | Juice Shop, DVWA | `/juice-shop/`, `/dvwa/` |

### तैनाती क्रम

1. पहले **ऑरिजिन सर्वर** तैनात करें -- यह बैकएंड एप्लिकेशन प्रदान करता है
2. ऑरिजिन सर्वर को ऑरिजिन पूल के रूप में उपयोग करते हुए **F5 XC HTTP लोड बैलेंसर** कॉन्फ़िगर करें
3. लोड बैलेंसर से **WAF, Bot Defense, API Security, और CSD पॉलिसी** अटैच करें
4. `target_fqdn` को F5 XC LB डोमेन पर सेट करके **ट्रैफ़िक जनरेटर** तैनात करें

### टारगेटिंग कॉन्फ़िगरेशन
...
`javascript-exploits` सूट विशेष रूप से ऑरिजिन सर्वर पर Client-Side Defense डेमो के लिए डिज़ाइन किया गया है। यह सूट CSD Phase 2 कार्यक्षमता को सत्यापित करता है:

**Phase 2 प्रवाह:**

1. ऑरिजिन सर्वर `/csd-demo/` पर CSD डेमो पेज होस्ट करता है
2. F5 XC CSD अपना मॉनिटरिंग JavaScript पेज में इंजेक्ट करता है
3. ट्रैफ़िक जनरेटर का javascript-exploits सूट निम्नलिखित प्रयास करता है:
   - Magecart स्किमर्स की नकल करने वाली इनलाइन स्क्रिप्ट इंजेक्ट करना
   - फ़ॉर्म सबमिशन को रीडायरेक्ट करने के लिए DOM एलिमेंट्स को संशोधित करना
...
## CDN सिमुलेटर इंटीग्रेशन

जब CDN सिमुलेटर तैनात होता है, तो आर्किटेक्चर में एक कैशिंग लेयर जुड़ जाती है:

```
Traffic Generator -> CDN Simulator -> F5 XC HTTP LB -> Origin Server
```

CDN सिमुलेटर F5 XC लोड बैलेंसर के सामने बैठता है, प्रतिक्रियाओं को कैश करता है और CDN-जैसे हेडर जोड़ता है। CDN के माध्यम से ट्रैफ़िक लक्षित करने के लिए:
...
यह दर्शाने के लिए उपयोगी है कि F5 XC CDN के माध्यम से आने वाले ट्रैफ़िक को कैसे संभालता है, जिसमें शामिल हैं:

- CDN प्रॉक्सी हेडर के पीछे वास्तविक क्लाइंट IP की पहचान करना
- उन अनुरोधों पर WAF नियम लागू करना जिन्हें CDN द्वारा संशोधित किया गया हो
- जब CDN ब्राउज़र फ़िंगरप्रिंट को संशोधित करता है तब Bot Defense वर्गीकरण
...
अपेक्षित: WAF SQL इंजेक्शन, XSS, और कमांड इंजेक्शन पेलोड को ब्लॉक करता है। Security Events डैशबोर्ड उल्लंघन विवरण के साथ ब्लॉक किए गए अनुरोध दिखाता है।
...
अपेक्षित: सभी पेलोड बिना फ़िल्टर किए ऑरिजिन एप्लिकेशन तक पहुँचते हैं। Juice Shop और DVWA अटैक पेलोड को प्रोसेस करते हैं। यह दर्शाता है कि F5 XC सुरक्षा के बिना क्या होता है।

### साइड-बाय-साइड डेमो प्रवाह

एक प्रभावशाली डेमो के लिए, एक ही सूट को दोनों तरह से चलाएँ:
...
4. सूट `meta.json` परिणामों की तुलना करें: डायरेक्ट रन अधिक "passed" (हमले सफल) दिखाते हैं, LB रन अधिक "failed" (हमले ब्लॉक) दिखाते हैं
