...
ट्रैफ़िक जनरेटर एक मल्टी-लेयर डेमो वातावरण का एक घटक है। जब सभी घटक तैनात होते हैं तो पूर्ण आर्किटेक्चर इस प्रकार होता है:
...
प्रत्येक घटक स्वतंत्र रूप से Terraform के माध्यम से तैनात और कॉन्फ़िगर किया जाता है। ट्रैफ़िक जनरेटर F5 XC लोड बैलेंसर FQDN को लक्षित करता है, न कि सीधे ऑरिजिन सर्वर को।

## ऑरिजिन सर्वर एकीकरण

[ऑरिजिन सर्वर](https://f5xc-salesdemos.github.io/origin-server/) बैकएंड एप्लिकेशन प्रदान करता है जिन्हें ट्रैफ़िक जनरेटर के अटैक सूट्स लक्षित करते हैं:
...
3. लोड बैलेंसर पर **WAF, Bot Defense, API Security, और CSD नीतियाँ** संलग्न करें
...
जब `TARGET_FQDN` सेट होता है, तो सभी सूट स्क्रिप्ट्स `https://<TARGET_FQDN>/...` पर ट्रैफ़िक भेजती हैं। F5 XC लोड बैलेंसर अनुरोध प्राप्त करता है, सुरक्षा नीतियाँ लागू करता है, और अनुमत ट्रैफ़िक को ऑरिजिन सर्वर पर अग्रेषित करता है।

## CSD डेमो एकीकरण

`javascript-exploits` सूट विशेष रूप से ऑरिजिन सर्वर पर Client-Side Defense डेमो के लिए डिज़ाइन किया गया है। यह सूट CSD Phase 2 कार्यक्षमता को मान्य करता है:

**Phase 2 प्रवाह:**

1. ऑरिजिन सर्वर `/csd-demo/` पर CSD डेमो पेज होस्ट करता है
2. F5 XC CSD अपनी मॉनिटरिंग JavaScript को पेज में इंजेक्ट करता है
3. ट्रैफ़िक जनरेटर का javascript-exploits सूट प्रयास करता है:
   - इनलाइन स्क्रिप्ट्स इंजेक्ट करना जो Magecart स्किमर्स की नकल करती हैं
   - DOM तत्वों को संशोधित करना ताकि फ़ॉर्म सबमिशन रीडायरेक्ट हों
   - अनधिकृत तृतीय-पक्ष JavaScript लोड करना
4. F5 XC CSD इन संशोधनों का पता लगाता है और CSD डैशबोर्ड में उनकी रिपोर्ट करता है

javascript-exploits सूट का उपयोग करने के लिए:
...
CDN सिम्युलेटर F5 XC लोड बैलेंसर के सामने बैठता है, प्रतिक्रियाओं को कैश करता है और CDN-जैसे हेडर जोड़ता है। CDN के माध्यम से ट्रैफ़िक को लक्षित करने के लिए:
...
यह प्रदर्शित करने के लिए उपयोगी है कि F5 XC CDN के माध्यम से आने वाले ट्रैफ़िक को कैसे संभालता है, जिसमें शामिल है:

- CDN प्रॉक्सी हेडर्स के पीछे वास्तविक क्लाइंट IP की पहचान करना
- उन अनुरोधों पर WAF नियम लागू करना जो CDN द्वारा संशोधित किए गए हो सकते हैं
- जब CDN ब्राउज़र फ़िंगरप्रिंट्स को संशोधित करता है तो Bot Defense वर्गीकरण
...
अपेक्षित: WAF SQL इंजेक्शन, XSS, और कमांड इंजेक्शन पेलोड्स को ब्लॉक करता है। Security Events डैशबोर्ड उल्लंघन विवरण के साथ ब्लॉक किए गए अनुरोधों को दिखाता है।
...
अपेक्षित: सभी पेलोड्स बिना फ़िल्टर किए ऑरिजिन एप्लिकेशन तक पहुँचते हैं। Juice Shop और DVWA अटैक पेलोड्स को प्रोसेस करते हैं। यह दर्शाता है कि F5 XC सुरक्षा के बिना क्या होता है।

### साथ-साथ डेमो प्रवाह

एक प्रभावशाली डेमो के लिए, दोनों तरीकों से एक ही सूट चलाएँ:

1. `web-app-attacks` सीधे ऑरिजिन के विरुद्ध चलाएँ -- दिखाएँ कि हमले सफल होते हैं
2. `web-app-attacks` F5 XC के माध्यम से चलाएँ -- दिखाएँ कि हमले ब्लॉक होते हैं
3. ब्लॉक किए गए अनुरोधों को प्रदर्शित करने के लिए F5 XC Security Events डैशबोर्ड खोलें
4. सूट `meta.json` परिणामों की तुलना करें: प्रत्यक्ष रन में अधिक "passed" (हमले सफल हुए) दिखाता है, LB रन में अधिक "failed" (हमले ब्लॉक हुए) दिखाता है
...
## मल्टी-कंपोनेंट Terraform तैनाती
