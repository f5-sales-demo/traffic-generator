...
Le [Serveur d'origine](https://f5-sales-demo.github.io/origin-server/) fournit les applications backend que les suites d'attaques du Générateur de trafic ciblent :
