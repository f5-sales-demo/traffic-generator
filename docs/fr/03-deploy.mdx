...
Tous les fichiers Terraform se trouvent dans le répertoire [`terraform/`](https://github.com/f5-sales-demo/traffic-generator/tree/main/terraform). Clonez le dépôt et déployez directement :
...
:::tip
F16s_v2 a été validé comme l'option optimale prix-performance par des tests de benchmarking A/B/C/D contre des cibles CDN F16s_v2 et F32s_v2. Consultez [benchmarks/](https://github.com/f5-sales-demo/traffic-generator/tree/main/benchmarks) pour les résultats complets.
:::
