...
All Terraform files are in the [`terraform/`](https://github.com/f5-sales-demo/traffic-generator/tree/main/terraform) directory. Clone the repository and deploy directly:
...
<!-- Linked-issue verification marker: #618. -->
