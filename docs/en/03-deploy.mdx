...
Before planning, authenticate profile `Users-280469140135` and verify that it resolves to account `280469140135` in `us-east-1`. The AWS Terraform guards also validate the target domain. Authentication failure is a hard stop.
