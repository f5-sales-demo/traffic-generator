...
El [servidor de origen](https://f5xc-salesdemos.github.io/origin-server/) proporciona las aplicaciones backend a las que se dirigen los conjuntos de ataques del generador de tráfico:
