...
:::note
ZAP y Metasploit añaden aproximadamente 1,5 GiB al espacio en disco y entre 5 y 10 minutos al tiempo de aprovisionamiento. Utilice el nivel completo solo si necesita específicamente estas herramientas para una demostración.
:::
...
| uv | Instalado como herramienta de Python usando el gestor de paquetes `uv` |
| pip | Instalado como paquete de Python usando `pip install` en el Python del sistema |
