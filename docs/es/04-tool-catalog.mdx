...
description: >-
  ...
  generadora de tráfico, organizadas por categoría con método de instalación,
  comandos de ejemplo y asignaciones a suites de tráfico
sidebar:
  order: 4
i18n:
...
| Herramienta | Método de Instalación | Comando de Ejemplo | Usada por Suite |
|---|---|---|---|
...
GoTestWAF (de Wallarm) es un framework estándar de la industria para evaluación de WAF que multiplica payloads a través de múltiples codificadores (URL, Base64, JSUnicode) y zonas de colocación (body, header, parámetro URL, cookie). waf-bypass (de Nemesida) envía payloads con codificación Base64, HTML-ENTITY y UTF-16 a través de las zonas ARGS, BODY, COOKIE y HEADER.
...
| puppeteer-extra-plugin-stealth | npm | Usado como plugin de Puppeteer para navegación sigilosa | bot-simulation |
...
| Herramienta | Método de Instalación | Ubicación | Usada por Suite |
|---|---|---|---|
...
| git clone + pip | Repositorio clonado y dependencias Python instaladas |
